<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.params.keyword" placeholder="名称、编号..." style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="标签" align="center" min-width="0">
        <template slot-scope="{row}">
          <el-tag v-if="row.design" type="success">设计</el-tag>
          <el-tag v-if="row.pattern" type="warning">打板</el-tag>
          <el-tag v-if="row.freeProofing" type="danger">免费打样</el-tag>
        </template>
      </el-table-column>
    </el-table>
